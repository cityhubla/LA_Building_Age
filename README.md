...
* There are missing dates on buildings even though their date is known through the [LA County APN Property Search](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=2&cad=rja&uact=8&ved=0CCYQjBAwAQ&url=http%3A%2F%2Fassessor.lacounty.gov%2Fextranet%2Fdatamaps%2Fpais.aspx&ei=CI1sVcbuGsqdsAXWsIKQBA&usg=AFQjCNFef0a1oPA1k5ajvZ3EapHWzsupKw&bvm=bv.94455598,d.b2w). The data worked with was from the 2011 parcel local roll, a look at the now released 2014 local roll through the County's Open Data portal shows that many have been updated with dates. My apartment for example did not have a date on this current age map. Updates will reflect the updated set.
